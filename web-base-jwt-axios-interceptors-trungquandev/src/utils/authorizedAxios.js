...
// Mục đích tạo Promise này để khi nhận yêu cầu refreshToken đầu tiên thì hold lại việc gọi API refreshtoken
// Đến khi nhận được kết quả từ API refreshtoken thì mới gọi tiếp các request khác
